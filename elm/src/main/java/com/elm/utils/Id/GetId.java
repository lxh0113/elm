...
public class GetId {
    ...
    public GetId(long workerId, long datacenterId, long sequence) {
 ...
 /*   public static void main(String[] args) {
        Server.GetId snowFlow = new Server.GetId(1, 1, 1);
        for (int i = 0; i < 20; i++) {
        //    id.append(snowFlow.nextId());
  ...
  */
    public static long getnewid() {
        GetId snowFlow = new GetId(1, 1, 1);
        //   System.out.println(snowFlow.nextId());
